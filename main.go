 ...
 * File: main.go
 * most of this file was provided by Dr. Hochstetler
 */
...
func handleInput(w io.Writer, input string, exit chan<- struct{}) error {
	...
	case "env": // env commmand
		return builtins.EnvironmentVariables(w, args...)
	case "sh": // sh command
		return builtins.Shell(args...)
	case "bash": // bash command
		return builtins.Bash(args...)
	case "csh": // CShell command
		return builtins.CShell()
	case "tcsh": // enhanced c shell command
		return builtins.TCShell()
	case "ksh": // KornShell command
		return builtins.Ksh()
	case "exit":
		exit <- struct{}{}
		return nil
